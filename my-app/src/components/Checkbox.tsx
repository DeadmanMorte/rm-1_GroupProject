...
// The Checkbox component is now defined using an interface CheckboxProps 
// that defines the checked and onClick props. The component is defined as 
// a function component that takes in these props with the FC generic type. 
// The MouseEventHandler type is imported from react to be used as the type 
// for the onClick prop. The props are now properly typed, making it easier 
